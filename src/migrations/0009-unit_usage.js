module.exports = {
  description: 'Copy unit_usage collection documents from source to target without modification.',
  ...
  async up({ sourceDb, targetDb, batchSize, dryRun, logger }) {
    ...
    logger.info('Starting unit_usage collection copy');
    ...
    logger.info(`Finished unit_usage collection copy. Total processed: ${processed}`);
  },
};
